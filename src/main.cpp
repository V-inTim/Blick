...
const char* ssid = "TP-Link_8204";
const char* password = "70602784";
...
String processor(const String& var){
  Serial.println("HELP SOS2");
  if(var == "BUTTONPLACEHOLDER"){
    String buttons = "";
    buttons += "<h4>Output - Light-emitting diode</h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"2\" " + outputState(output) + "><span class=\"slider\"></span></label>";
